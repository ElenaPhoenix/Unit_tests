...
public class MainS1 {
    ...
    public static void checkingShoppingCart() {
        ...
        for (String product : products) { 
            if (product.equals("apple")) { // на if нажать левой кнопкой мыши, alt+enter - преобразование в switch case
    ...
    public static void testingJavaCollectionsAssertJ(String[] colors) {
        assertThat(colors)
                .isNotEmpty() //тест идет последовательно построчно. сначала максимально широкий тест, потом на сужение
                .hasSize(7)
